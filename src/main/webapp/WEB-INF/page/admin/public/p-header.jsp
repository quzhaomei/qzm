		...
		<div class="navbar-inner">
			...
			<img src="../images/cathead.svg" style="width:30px;height:30px; position:absolute;top:5px;left:5px;"/>
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-bar"></span> </a> <a class="brand" href="index.htmls"><span>系统后台管理</span>
				</a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown"><a class="btn dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<%=basePath %>loginout.htmls"><i class="halflings-icon user"></i>
										切换用户</a>
								</li>
								<li><a href="<%=basePath %>loginout.htmls"><i class="halflings-icon off"></i>
										安全退出</a>
								</li>
							</ul></li>
						<!-- end: User Dropdown -->
