	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				<ul class="breadcrumb">
					<li><i class="icon-home"></i> <a href="index.htmls">首页</a> <i
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<!-- table框架 -->
						<form action="index.htmls" method="post" id="myform" rel="admin-form">
					...
					<select name="type" rel="chosen" style="width:150px;" id="tagType">
							...
							<table class="table table-striped table-bordered">
								...
								<c:forEach items="${pageResult.param }" var="user">
									<tr>
										...
										<!-- 删除用户 -->
										<ad:power   uri="/user/delete.htmls">		
							...
							<!--分页控制  -->
								<ad:page pageIndex="${pageResult.pageIndex }"
									 ...
									 totalPage="${pageResult.totalPage}" count="${pageResult.count}"></ad:page>
						</div>
						<!-- 数据展示结束 -->
