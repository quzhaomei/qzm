...
public class PageTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		pageHtml=getHtml(pageSize, pageIndex, totalPage,count);
		getJspContext().getOut().print(pageHtml);
		super.doTag();
	}
	private String getHtml(Integer pageSize,Integer pageIndex,Integer totalPage,Integer count){
		if(totalPage<2){
			return "";
		}
		...
		html.append("<li class=\"disabled\" ><a  href=\"#\" >共"+count+"条 </a></li>");
